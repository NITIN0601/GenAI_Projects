...
from rag.query_understanding import QueryUnderstanding, QueryType, ParsedQuery, get_query_understanding
from rag.table_consolidation import TableConsolidationEngine, get_consolidation_engine
...
class QueryProcessor:
    ...
    def _handle_cross_table(
        ...
        for table_type in parsed_query.table_types:
            ...
            results = self.vector_store.search(
                query_text=search_text,
                top_k=top_k // len(parsed_query.table_types),
                filter=filters
            )
